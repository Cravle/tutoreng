/*
  ...
  - You are about to drop the column `userId` on the `ScheduleEvent` table. All the data in the column will be lost.
  - You are about to drop the `_guests` table. If the table is not empty, all the data it contains will be lost.

*/
-- DropForeignKey
ALTER TABLE "ScheduleEvent" DROP CONSTRAINT "ScheduleEvent_userId_fkey";
...
-- AlterTable
ALTER TABLE "ScheduleEvent" DROP COLUMN "userId";
